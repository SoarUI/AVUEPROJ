...
.detailcontainer .info_list{margin-left: 10px;flex:1;position: relative;}
.detailcontainer .info_list h2{font-size: 17px;line-height: 24px;width: 150px;overflow: hidden;
                        white-space: nowrap;text-overflow: ellipsis;}
.detailcontainer .info_list p{font-size: 13px;color: #666;line-height: 22px;width: 200px;
                    overflow: hidden;white-space: nowrap;text-overflow:ellipsis;}
.detailcontainer .info_list .p-right{float:left;flex:1;
                    overflow: hidden;white-space: nowrap;text-overflow:ellipsis;}
.detailcontainer .info_list .p-left{float:left;flex:1;
                    overflow: hidden;white-space: nowrap;text-overflow:ellipsis;}
.detailcontainer .info_list .Line{float:left;display:flex;flex-direction: row; white-space: nowrap;text-overflow:ellipsis;width:100%;}
.detailcontainer .info_list .info{font-size: 13px;color: #666;line-height: 22px;width: 100%;
                        white-space:normal;text-overflow:ellipsis;}
.detailcontainer .info_list .p-left .grade{font-size: 15px;font-weight: 700;color: #faaf00;}
</style>
