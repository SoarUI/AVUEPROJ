    ...
    <ul>
        <li>
            ...
            <div class="info_list">
                ...
                <p>运营商:深圳乐瞬科技有限公司</p>
                <div class="info">这款游戏总体来说，还是值得各位期待的，精美的画面和流畅的场景，是大众娱乐的一大风景！</div>
...
._body .info_list .info{font-size: 13px;color: #666;line-height: 22px;width: 200px;;white-space:normal;text-overflow:ellipsis;}
